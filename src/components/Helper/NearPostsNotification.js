...
import EnhancedChatSnackbar from './EnhancedChatSnackbar';
...
export default function NearPostsNotification({darkMode}) {
  ...
  return (
    <Box>
      ...
      <EnhancedChatSnackbar
        chatNotificationView={chatNotificationView}
        setChatNotificationView={setChatNotificationView}
        chatNotificationData={chatNotificationData}
        chatNotificationPath={chatNotificationPath}
        navigate={navigate}
        darkMode={darkMode}
      />
      {/* <Snackbar
