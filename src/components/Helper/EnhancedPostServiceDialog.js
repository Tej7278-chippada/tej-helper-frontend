...
const EnhancedPostServiceDialog = ({ openDialog, handleCloseDialog, theme, isMobile, fetchPostsData, generatedImages, loadingGeneration,
  ...
  setSnackbar, submitError, protectLocation, setProtectLocation, fakeAddress, setFakeAddress, }) => {
  ...
  const steps = ['Location & Privacy', 'Media & Images', 'Service Details', 'Schedule & Submit'];
  ...
  //                       Show approximate location within 500m radius
  //                     </Typography>
  //                   </Box>
  //                 </Box>
  //                 <Switch
  ...
  //         {/* Map Placeholder */}
  //         <Card elevation={0} sx={{ borderRadius: 3, height: 300, bgcolor: 'grey.100' }}>
  //           <Box 
  //             sx={{ 
  //               height: '100%', 
  //               display: 'flex', 
  ...
  //                 onClick={() => setLoadingGeneration(true)}
  ...
  //               Maximum 5 photos allowed. Supported formats: PNG, JPEG, WebP
  //             </Typography>
  ...
  //                   <MenuItem value="UnPaid">Free Service</MenuItem>
  ...
  //               )}
  //               <Typography variant="body2">
  //                 <strong>Target:</strong> {formData.gender || 'Not specified'}
  //               </Typography>
  //             </Box>
  //           </CardContent>
  //         </Card>
